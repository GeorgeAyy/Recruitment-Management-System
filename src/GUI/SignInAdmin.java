...
public class SignInAdmin extends Scene{

    public SignInAdmin(StackPane root, double d, double d1, Stage primaryStage) {
        super(root, d, d1);
        ...
        Label signin = new Label("Sign In as an Admin");
        ...
        SignInBtn.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event) {
                ...
                if(r.loginAsAdmin(username, password) == true)
                    {
