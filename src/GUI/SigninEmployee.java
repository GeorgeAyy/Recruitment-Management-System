 ...
 * @author georg
 */
public class SigninEmployee extends Scene{

    public SigninEmployee(StackPane root,double d, double d1,Stage primaryStage) {
        super(root,d,d1);
        ...
        Label signin = new Label("Sign In as an Employee");
        ...
        SignInBtn.setOnAction(new EventHandler<ActionEvent>(){
            ...
            public void handle(ActionEvent event) {
                ...
                int index = 0;
                if(r.loginAsEmployee(username, password, index) == true)
                    {
                        System.out.println(index);
                        primaryStage.setScene(new EmployeeScreen(new StackPane(),1200,700,primaryStage,r.getEmployee(username),index));
                    }
                else
                {
                    error.setText("Invali Username or Password");
                }
                }
                catch(IOException e)
                {
